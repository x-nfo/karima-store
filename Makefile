...
# --- MODE LOKAL (Hybrid) ---
# Gunakan ini saat develop kode agar cepat (DB di docker, App di Terminal)
dev-local:
...
kratos-up:
	...
	docker compose -f docker-compose.yml -f docker-compose.kratos.yml up -d kratos-migrate kratos kratos-selfservice-ui-node mailslurper

# Matikan Kratos Services
kratos-down:
	@echo "Menghentikan layanan Ory Kratos..."
	docker compose -f docker-compose.yml -f docker-compose.kratos.yml stop kratos-migrate kratos kratos-selfservice-ui-node mailslurper
...
help:
	...
	@echo ""
	@echo "Development:"
	@echo "  make dev-local       - Run app locally (DB in docker)"
